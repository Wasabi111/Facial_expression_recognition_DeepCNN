...
parser.add_argument('--model', default='models/prune_models/PrivateTest_model.t7',
                    help='path to raw trained model (default: none)')
parser.add_argument('--save', default='models/prune_models/PrivateTest_modelprune.t7',
